...
% Question 2
% Which of the following stimulus strength values and stimulus durations
% will lead to "anode break" excitation?

% Stimulus strength=6, Stimulus duration= 2 ms
% Stimulus strength=4, Stimulus duration= 3 ms
% Stimulus strength=5, Stimulus duration= 5 ms
% Stimulus strength=8, Stimulus duration= 1 ms
% 
...
stimdelay = 5 ;
stimdur = 5 ;    % ANSWER Stimulus strength=5, Stimulus duration= 5 ms
stim_amp = 5 ;

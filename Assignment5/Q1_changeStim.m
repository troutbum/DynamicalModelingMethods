...
% Question 1
% Download these Matlab files:
% 
% hh.m : Master program for solving Hodgkin-Huxley model
% dydt_hh.m : Function that computes derivatives of Hodgkin-Huxley state
% variables
% 
% In the lectures, it was shown that the Hodgkin-Huxley model was able to
% reproduce the phenomenon of "anode break" excitation. Using the program
% hh.m, test different cathodal (depolarizing) and anodal (hyperpolarizing)
% stimuli. The duration of the stimulus is currently set to be 3 ms (line
% 50 in the code) and the stimulus strength and polarity are set on line 51
% in the code. According to the convention used in this program, a negative
% stimulus depolarizes the cell membrane. Which of the following values for
% stimulus will induce an action potential if the stimulus duration is 3
% ms?
% 1
% 5
% -3
...
stimdelay = 5 ;
stimdur = 3 ;
stim_amp = -3 ;  % ANSWER action potential from depolarization
                 % negative stimulus is depolarization in model
